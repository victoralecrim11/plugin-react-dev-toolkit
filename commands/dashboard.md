...
Caso o Project Hub ainda não exista na máquina: sugira `/setup`, que faz a instalação completa. Se o usuário preferir apenas o painel agora, copie `${CLAUDE_PLUGIN_ROOT}/skills/dashboard-projetos/references/dashboard-server.py`, `dashboard-template.html` e o inicializador para a pasta desejada e execute ali mesmo.
